            ...
            <div className={styles.header_container}>
                <div className={styles.header_left}>
                    ...
                    <ul className={styles.header_routing_list}>
                        <li className={styles.header_routing_items}><Link to="services" smooth={true} duration={500}>• Услуги</Link></li>
                        <li className={styles.header_routing_items}><Link to="about_us" smooth={true} duration={500}>• О Нас</Link></li>
                    </ul>
                </div>
